        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links">
            ...
            <a href={props.link2Url}>
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text13 thq-body-small thq-link">
                    Link 2
                  </span>
                </Fragment>
              )}
          ...
          <div className="navbar8-buttons">
            <button className="navbar8-action1 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text07">Main Action</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action2 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text10">Secondary Action</span>
                  </Fragment>
                )}
              </span>
            </button>
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1695654689751-a6e9086c13e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjYwNjI4MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
  link2Url: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1441205188609-b875e92a9807?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjYwNjI4MXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1708681883598-2c5fa0401b62?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjYwNjI4Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  link3: undefined,
  ...
  page4ImageAlt: 'image',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1611800065437-f033a1d04b6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMjYwNjI4MXw&ixlib=rb-4.0.3&q=80&w=1080',
  link2: undefined,
  link1: undefined,
