      ...
      <header data-thq="thq-navbar" className="navbar2-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links">
            ...
            <a href={props.link4Url} className="navbar2-link4">
              {props.link4 ?? (
                <Fragment>
            ...
            <a href={props.link5Url} className="navbar2-link5">
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar2-text thq-body-small thq-link">
                    Contact Us
                  </span>
                </Fragment>
              )}
