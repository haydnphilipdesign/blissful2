...
const Footer15 = (props) => {
  return (
    <footer className="footer15-container thq-section-padding">
      <div className="footer15-max-width thq-section-max-width">
          ...
          <div className="footer15-actions">
            <div className="footer15-newsletter">
              <span>
                {props.content1 ?? (
                  <Fragment>
                    <span className="footer15-text thq-body-small">
                      Blissful Existence Healing Acres offers equine therapy and
                      meditation retreats in the tranquil Pocono Mountains.
                      Personalized treatment plans, ongoing support, and
              ...
              <div className="footer15-actions1">
                <div className="footer15-form">
                  ...
                  <button className="thq-button-outline footer15-button">
                    <span>
                      {props.action1 ?? (
                        <Fragment>
                          <span className="footer15-text3 thq-body-small">
                ...
                <span>
                  {props.content2 ?? (
                    <Fragment>
                      <span className="footer15-text6 thq-body-small">
        ...
        <div className="footer15-credits">
          <div className="footer15-row">
            <div className="footer15-credits1">
              <span>
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer15-text5 thq-body-small">
                      Default value
                    </span>
                  </Fragment>
                )}
              ...
              <span>
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer15-text2 thq-body-small">
                      Default value
                    </span>
                  </Fragment>
                )}
              ...
              <span>
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer15-text1 thq-body-small">
                      Default value
                    </span>
                  </Fragment>
                )}
          ...
          <span>
            {props.copyright ?? (
              <Fragment>
                <span className="footer15-text4 thq-body-small">
