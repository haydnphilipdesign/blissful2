        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing14-text058 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text076 thq-body-large">N/A</p>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text086 thq-body-small">
                            Individualized meditation guidance
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing14-text074 thq-body-large">
                          Business plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text073 thq-heading-3">
                          $29/mo
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text088 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text078 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
